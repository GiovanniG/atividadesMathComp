...
//uso da fórmula (a)(extremo intervalo direito) para o cálculo de aproximação da integração pela regra dos retângulos

//4 retângulos=4.280093
//100 retângulos=4,651647
